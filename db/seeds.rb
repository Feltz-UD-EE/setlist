...
s08 = b.songs.create(band_id: b.id, title: "Better Man", performer: "Pearl Jam", duration: 200, intro: "Keyboard and plucked guitar")
...
s22 = b.songs.create(band_id: b.id, title: "Sympathy for the Devil", performer: "The Rolling Stones", duration: 240, intro: "Keyboard and Vocals")
...
s26 = b.songs.create(band_id: b.id, title: "Twilight Zone", performer: "Golden Earring", duration: 300, intro: "Keyboard and guitar, then spoken word vocals")
